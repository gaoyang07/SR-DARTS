...
def get_arguments():
    ...
    # for making the lr scheduler
    parser.add_argument('--lr_mode', type=int, default=0,
                        help='learning rate scheduler strategy')
    parser.add_argument('--steps', type=tuple, default=(20, 100, 200))
...
def main():
    ...
    if args.lr_mode == 0:
        ...
        scheduler = utils.make_lr_scheduler(args, optimizer)
    else:
        raise NotImplementedError("No 3rd lr scheduler yet.")
